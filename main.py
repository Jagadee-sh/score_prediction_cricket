...
def load_ufc():
    df = pd.read_csv(r"C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\UFC.csv")
    return df
...
def load_odi():
    odi = pd.read_csv('https://d.docs.live.net/f75314e7e69f932f/%E3%83%89%E3%82%AD%E3%83%A5%E3%83%A1%E3%83%B3%E3%83%88/ODI_data.csv')
...
def load_data2():
    t20 = pd.read_csv(r'C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\t20.csv')
...
def load_data3():
   ...
   test = pd.read_csv(r'C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\test.csv')
...
def load_data4():
    bowling_odi = pd.read_csv(r'C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\Bowling_ODI.csv')
    #delete unnamed: 0 column
...
def load_data5():
    bowling_t20 = pd.read_csv(r'C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\Bowling_t20.csv')
    #delete unnamed: 0 column
...
def load_data6():
    bowling_test = pd.read_csv(r'C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\Bowling_test.csv')
    #delete unnamed: 0 column
...
def load_data7():
    fielding_odi = pd.read_csv(r'C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\Fielding_ODI.csv')
    #delete unnamed: 0 column
...
def load_data8():
    fielding_t20 = pd.read_csv(r'C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\Fielding_t20.csv')
    #delete unnamed: 0 column
...
def load_data9():
    fielding_test = pd.read_csv(r'C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\Fielding_test.csv')
    #delete unnamed: 0 column
...
@app.route('/')
def index():
    return render_template('C:\Users\HP\Documents\jeevan\jeevan py\index2.html')

@app.route('/about')
def about():
    return render_template('C:\Users\HP\Documents\jeevan\jeevan py\about.html')
...
def graph_1():
    ...
    return render_template('C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\html.sports\graph1.html', 
                           fig1= fig1.to_html(),
                           fig2= fig2.to_html(),
                           fig3= fig3.to_html(),
                           fig4= fig4.to_html(),
...
@app.route('/ufc')
def load_ufc():
    return render_template('C:\Users\HP\Documents\jeevan\jeevan py\ufc.html')  

@app.route('/football')
def load_foot():
    return render_template('C:\Users\HP\Documents\jeevan\jeevan py\football.html')
...
def cricket():
    if request.method == 'POST':
        ...
        if choice == 'bat_odi':
            ...
            return render_template('C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\html.sports\"C:\Users\HP\Documents\jeevan\jeevan py\csv.sports\html.sports\cricket.html',
            ...
            return render_template('C:\Users\HP\Documents\jeevan\jeevan py\cricket.html',
